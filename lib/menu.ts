...
export const CATEGORIES: MenuLink[] = [
  { label: "Beauté Beauty", href: "/beaute-beauty", image: "/images/Categories/tsgabrielle-Beaute-Beauty.png" },
  { label: "Accessories", href: "/accessories", image: "/images/Categories/tsgabrielle-Accessories.png" },
  { label: "Hats", href: "/hats", image: "/images/Categories/tsgabrielle-Hats.png" },
  { label: "For Him 👔", href: "/for-him", image: "/images/Categories/tsgabrielle-For-Him.png" },
  { label: "For Her 👗", href: "/for-her", image: "/images/Categories/tsgabrielle-for-her.png" },
  { label: "🏡 Home & Décor", href: "/home-decor", image: "/images/Categories/tsgabrielle-Home-&-Decor.png" }
];

export const COLLECTIONS: MenuLink[] = [
  { label: "Peach Phoenix™", href: "/peach-phoenix", image: "/images/Collections/Peach Phoenix/Peach_Phienix.PNG" },
  ...
  { label: "Womanizer", href: "/womanizer", image: "/images/Collections/Womanizer/Womanizer.png" },
  { label: "Flamant 🦩 Rose", href: "/flamant-rose", image: "/images/Collections/Flamant Rose/Flamant-Rose.png" },
  { label: "🌌✨ Édition Spatiale", href: "/edition-spatiale", image: "/images/Collections/Édition Spatiale/Édition-Spatiale-by-tsgabrielle.png" },
  { label: "Unicorn 🦄", href: "/unicorn" },
  { label: "Crystal Skies.", href: "/crystal-skies", image: "/images/Collections/Crystal Skies/Crystal Skies.png" },
  { label: "🌈 Pride 26", href: "/pride-26" },
  { label: "❄️ Glow in Winter 26", href: "/glow-in-winter-26", image: "/images/Collections/Glow in Winter 26/tsgabrielle-Glow-in-Winter26-new.png" },
