        ...
        <main className="min-h-screen bg-white text-white font-sans">
            ...
            <section className="py-32 px-8">
                <div className="max-w-4xl mx-auto space-y-16 text-sm text-slate-400 font-light leading-relaxed">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-white">01. Ownership</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-white">02. Permitted Use</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-white">03. Prohibited Use</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-white">04. Content Licensing</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-white">05. User-Generated Content</h2>
                        <p>
