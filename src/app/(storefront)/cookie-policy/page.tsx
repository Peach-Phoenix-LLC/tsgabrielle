        ...
        <main className="min-h-screen bg-white text-[#1a1a1a] font-sans">
            ...
            <section className="py-32 px-8">
                <div className="max-w-4xl mx-auto space-y-16 text-sm text-[#1a1a1a]/60 font-light leading-relaxed">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">01. What Are Cookies</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">02. Types of Cookies We Use</h2>
                        <p>
                            <b className="text-[#1a1a1a]">Essential cookies</b> are necessary for the website to function properly and cannot be switched off. <b className="text-[#1a1a1a]">Analytics cookies</b> allow us to count visits and traffic sources so we can measure and improve performance of our website. We use tools such as Google Analytics for this purpose. <b className="text-[#1a1a1a]">Preference cookies</b> enable the website to remember information that changes the way the website behaves or looks. <b className="text-[#1a1a1a]">Marketing cookies</b> may be set by our advertising partners to build a profile of your interests and show you relevant advertisements on other sites.
                        </p>
                    </div>

                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">03. Third-Party Cookies</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">04. Managing Cookies</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">05. Changes to This Policy</h2>
                        <p>
