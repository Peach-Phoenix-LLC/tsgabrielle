        ...
        <main className="min-h-screen bg-white text-[#1a1a1a] font-sans">
            ...
            <section className="py-32 px-8">
                <div className="max-w-4xl mx-auto space-y-16 text-sm text-[#1a1a1a]/60 font-light leading-relaxed">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">01. Affiliate Links</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">02. Sponsored Content</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">03. Product Reviews</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">04. FTC Compliance</h2>
                        <p>
