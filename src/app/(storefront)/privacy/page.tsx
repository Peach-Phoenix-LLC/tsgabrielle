        ...
        <main className="min-h-screen bg-white text-[#1a1a1a] font-sans">
            ...
            <section className="py-32 px-8">
                <div className="max-w-4xl mx-auto space-y-16 text-sm text-[#1a1a1a]/60 font-light leading-relaxed">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">01. Information Collection</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">02. Utilization of Data</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">05. Your Rights</h2>
                        <p>
                    ...
                    <div className="pt-12 border-t border-black/10 space-y-4">
                        ...
                        <p className="text-[10px] uppercase tracking-[0.2em] text-[#1a1a1a]/40 pt-4">© 2026 TSGABRIELLE®. ALL IDENTITY RESERVED.</p>
                    </div>
