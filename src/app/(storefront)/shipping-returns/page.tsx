            ...
            <section className="py-32 px-8">
                <div className="max-w-4xl mx-auto space-y-24">
                        ...
                        <div className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                <div className="space-y-4">
                                    <h3 className="text-xs uppercase tracking-[0.2em] font-bold text-[#1a1a1a]">United States</h3>
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-xs uppercase tracking-[0.2em] font-bold text-[#1a1a1a]">International</h3>
                                    <p className="text-sm text-[#1a1a1a]/60 font-light leading-relaxed">
                                        Express global shipping via DHL. Delivery timelines vary by region but typically arrive within 5-7 business days.
                                    </p>
                                </div>
                            </div>
                            <div className="bg-neutral-50 p-8 rounded-sm border border-black/10">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="space-y-6 text-sm text-[#1a1a1a]/60 font-light leading-relaxed">
                            <p>
                            ...
                            <ul className="list-disc pl-5 space-y-4 pt-4">
                                ...
                                <li>Returns must be initiated through our <Link href="/contact" className="text-[#1a1a1a] hover:text-[#a932bd] underline decoration-[#a932bd]/30 underline-offset-4 transition-colors">Digital Concierge</Link>.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="p-8 border border-white/10 rounded-sm space-y-4">
                                ...
                                <p className="text-xs text-[#1a1a1a]/40 leading-relaxed font-light">Notify our concierge within 14 days of receipt.</p>
                            </div>
                            <div className="p-8 border border-white/10 rounded-sm space-y-4">
                                <span className="text-2xl font-serif text-[#a932bd]">02</span>
                                <h4 className="text-[10px] uppercase tracking-[0.2em] font-bold">Pack</h4>
                                <p className="text-xs text-[#1a1a1a]/40 leading-relaxed font-light">Use the original shipping box and included return label.</p>
                            </div>
                            <div className="p-8 border border-white/10 rounded-sm space-y-4">
                                ...
                                <p className="text-xs text-[#1a1a1a]/40 leading-relaxed font-light">Upon inspection, your refund will be processed to the original payment method.</p>
                            </div>
                        </div>
                    </div>
