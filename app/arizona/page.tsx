...
export const metadata = buildMetadata({
  ...
  keywords: [
    "arizona collection",
    "desert luxury streetwear",
    "purple mirage",
    "desert resilience",
    "earthy minimalism",
    "futuristic desert accents",
    "sun bleached style",
    "tsgabrielle royal purple",
    "endless horizon fashion",
    "holographic mirage",
    "heat inspired apparel",
    "desert strength streetwear",
    "french trans touch desert",
    "warm neutral clothing",
    "survival beauty fashion",
    "unexpected beauty apparel",
    "luxury desert aesthetic",
    "purple lens fashion",
    "vast landscape style",
    "quiet power apparel",
    "heat resilience",
    "future desert streetwear",
    "tsgabrielle arizona",
    "desert mirage glow",
