        ...
        <main className="min-h-screen bg-white text-[#1a1a1a] font-sans">
            ...
            <section className="py-32 px-8">
                <div className="max-w-4xl mx-auto space-y-16 text-sm text-[#1a1a1a]/60 font-light leading-relaxed">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">01. Digital Products &amp; Services</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">02. Physical Products</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">03. Services</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">04. Subscription Plans</h2>
                        <p>
                    ...
                    <div className="space-y-6">
                        <h2 className="text-xl font-serif text-[#1a1a1a]">07. Non-Refundable Items</h2>
                        <p>
